# nvim-treesitter-queries-xresources

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-xresources/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-xresources/actions/workflows/validate.yml)

Neovim tree-sitter queries for **xresources**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-xresources",
...
- [ ] Changes are scoped to `xresources` — do not include files for other languages
